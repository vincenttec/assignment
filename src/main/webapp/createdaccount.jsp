<%@ page language="java" contentType="text/html; chaResultSetet=ISO-8859-1"
...
<html>
<head>
<meta chaResultSetet="ISO-8859-1">
...
<p>Created account information</p>
 ...
 <td><a href="Deletee?id=<%=ResultSet.getString(1)  %>" >  &nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary" value="delete">DELETE</button></a>
                  </td>
